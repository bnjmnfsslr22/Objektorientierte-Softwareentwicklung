...
public interface Bank {
   ...
   // public void createAccount(String account,List<Transaction>transactions)throws AccountAlreadyExistsException, IOException
    ...
    /**
     * Deletes an account. If the Account does not exist an Exception is thrown.
     * 
     * @param account the selected account
     * @throws AccountDoesNotExistException
     * @throws IOException
     */
    void deleteAccount(String account) throws 
    AccountDoesNotExistException, IOException;
